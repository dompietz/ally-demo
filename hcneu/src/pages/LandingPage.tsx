        ...
        {[
          {
            ...
            image:
              "https://images.unsplash.com/photo-1425913397330-cf8af2ff40a1?q=80&w=1374",
          },
          {
            title: "Deine persönliche Bibliothek",
            description:
              "Erhalte Artikel, Tipps und Übungen – auf dich abgestimmt.",
            image:
              "https://images.unsplash.com/photo-1506744038136-46273834b3fb?q=80&w=1374",
          },
          {
            title: "Export für Arzttermine",
            description:
              "Exportiere deine Daten als PDF und behalte den Überblick.",
            image:
              "https://images.unsplash.com/photo-1504711434969-e33886168f5c?q=80&w=1374",
          },
        ].map((tile, idx) => (
      ...
      <section id="faq" className="faq">
        ...
        <details className="faq-item">
          ...
          <div className="faq-body">
            <p>
              Ally sammelt deine Eingaben zu Symptomen, Wohlbefinden und
              Lebensstil und erstellt daraus Trends, die dir helfen, Muster zu
              erkennen. Die Informationen bleiben auf europäischen Servern und
              sind nach DSGVO geschützt.
            </p>
          </div>
        </details>
        ...
        <details className="faq-item">
          ...
          <div className="faq-body">
            <p>
              Ja, du kannst Ally 30&nbsp;Tage lang unverbindlich testen.
              Innerhalb dieser Zeit kannst du jederzeit kündigen und es fallen
              keine Kosten an.
            </p>
          </div>
        </details>
        ...
        <details className="faq-item">
          ...
          <div className="faq-body">
            <p>
              Eine native iOS- und Android-App ist in Entwicklung und wird in
              der zweiten Jahreshälfte&nbsp;2025 veröffentlicht. Bis dahin
              kannst du die Web-App auf dem Smartphone wie gewohnt über den
              Browser nutzen.
            </p>
          </div>
        </details>
        ...
        <details className="faq-item">
          ...
          <div className="faq-body">
            <p>
              Ally ist ein Produkt der HealthCovery&nbsp;GmbH, einem
              interdisziplinären Team aus Ärzt*innen, Entwickler*innen und
